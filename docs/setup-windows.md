...
The first launch downloads the Ubuntu 24.04 cloud image (a few minutes on a fresh machine).
...
multipass mount C:\path linux-ops-lab:/mnt/host    # share a host folder into the VM
```
